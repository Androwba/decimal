...
START_TEST(int_to_decimal_dst_NULL) {
  int src1 = 0;
  s21_from_int_to_decimal(src1, NULL);
}
END_TEST

START_TEST(dec_to_int_0) {
  s21_decimal src = {{0, 0, 0, 0}};
  s21_from_decimal_to_int(src, NULL);
}
END_TEST
...
START_TEST(dec_to_int_28) {
  int EXPONENT_MORE_THAN_28 = 2835008;
  int INT_MAX = 2147483647;
  int result = 0;
  s21_decimal src = {{INT_MAX, 0, 0, EXPONENT_MORE_THAN_28}};
...
START_TEST(dec_to_float_0) {
  s21_decimal src = {{0, 0, 0, 0}};
  s21_from_decimal_to_float(src, NULL);
}
END_TEST
...
START_TEST(dec_to_float_37) {
  float EXPONENT_MORE_THAN_28 = 2835008;
  float INT_MAX = 2147483647;
  float result = 0.0;
  s21_decimal src = {{INT_MAX, 0, 0, EXPONENT_MORE_THAN_28}};
...
//   ck_assert_int_eq(err_check, CONVERTION_ERROR);
...
void srunner_add_cast_tests(SRunner *sr) {
  ...
  tcase_add_test(tc1_1, int_to_decimal_dst_NULL);
  tcase_add_test(tc1_1, dec_to_int_0);
  ...
  tcase_add_test(tc1_1, dec_to_float_0);
